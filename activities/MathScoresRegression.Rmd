...
**The linear regression line shows us that schools with higher percentages of students who meet or exceed math expectations also have higher percentages of students on the FARMS program, however, this is a weak relationship between the two. **
...
**This model is not worth using, because neither the p-value nor the adjusted r-squared are significant. This means that there an insignificant relationship between the two values, and they will be unable to accurately predict each other, so therefore the model is not useful within this context.**
...
**Whitemarsh Elementary School has a 45.8 point gulf between the predicted and actual results, while Rydal West School, Merion Elementary School and Lower Gwynedd Elementary School all have differences above 30 points.**
...
**This model shows vast inaccuracies in its predictive modeling, which, alongside analyses of the p-value and adjusted r-squared value, leads me to believe that the two scores are not significantly correlated, and therefore the school board member's comments are inaccurate. I would pitch a story explaining that FARMS percentages are not predictive of math scores, so the member's comments are not based within reality.**
