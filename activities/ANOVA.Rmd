...
**Private and Public colleges enroll student populations with significantly higher mean SAT scores than Community colleges. Both Private and Public colleges enroll students with perfect scores, while Community colleges do not.  Private schools have the highest mean SAT scores, and those scores are more tightly concentrated than those of students at Community or Public schools, which have a greater variance within enrolled populations. **
...
**1. Yes, as the Tukey HSD test shows that there are highly significant differences in SAT scores between college types**

**2. Public and Private differ greatly from Community colleges, but are only separated by about 75 points themselves**

**3. Between Private and Community, it's about 367 points, and between Public and Community, its about 293.**

**Headline: Private colleges still attract higher SAT score than public schools**

**Lede: Despite reports on the rise of the so-called "Public Ivies", private colleges are still attracting students with the highest SAT scores, even as the SAT wanes in its importance in the college admission process. According to recent data, students at private colleges scores had a mean SAT score 74 points higher than their peers at public institutions.**
