...
52% support, sample size 100: MoE of 10
53% support, sample size 800: MoE of 3.5
55% support, sample size 400: MoE of 5
...
For these sample sizes, the headline 'Majority Supports New City Policy' risks being statistically incorrect/misleading, especially with the first two situations, but even the third holds a possibility of evenly split support. A better headline would be, 'City Split Over New Policy'. 
...
In the neighborhoods surrounding Activity City's latest transit line, homeowners have a reason to celebrate--the values of their homes have been increasing faster than those in the rest of the region, something local Activity City lawmakers attribute to the transit line's expansion. We looked into the data and it's true, home values have increased around the new line's route, but the Activity City Realtor Association says expanded transit isn't the whole story. 
