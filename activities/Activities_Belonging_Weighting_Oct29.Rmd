...
This is because without close reading, a stakeholder could draw inaccurate conclusions based on the data, since some of these decisions alter and regroup dissimilar data together, which could alter final determinations made with it. Also, the choice to redact certain small population estimates it noteworthy when considering outliers.
...
1. What is the range of weights in this dataset? **Write your answer here:** The range is 0.23 to 3.04.

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? **Write your answer here:** 0.23 means a fourth of a respondent counts as a person, or one respondent equals four persons, while 3.04 means three respondent counts as one person, or one respondent counts as a third of a person. 

3. Why might some respondents be weighted more heavily than others? **Write your answer here:** Some respondent populations are more likely to answer surveys than others, meaning that they will appear in the response data more frequently than they do in the overall population. 
...
2. How might these differences affect reporting on likely voter turnout? **Write your answer here:** There would likely be no change to the reporting on likely voter turnout, as the always, and the sporadic, data showed no significant change between weighted and unweighted analyses. Always showed the least change of any category.

3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample? **Write your answer here:** Rarely/never voters who are not planning on voting in the upcoming election were slightly underrepresented in the data, which makes sense, since less civically engaged individuals are also likely to be less engaged with polling efforts. 
