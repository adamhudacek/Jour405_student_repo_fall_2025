...
**When comparing pre-spike rates to post-spike rates, he median rate more than doubled from 22.2  to 46.2. However, the number of observations also fell dramatically, by over 80 percent. This suggests the data might not be entirely comparable.**
...
**The chart shows how the spike year impacted the number of thefts within the population, and how numbers remained high post-spike. A better headline might be, "Thefts remains high a year after the crime spiked."**
...
- **Null Hypothesis (H0)**:   There are no significant differences in the average rates between the time periods.

- **Alternative Hypothesis (H1)**: There are significant differences in the average rates between the time periods.
...
**The p-value shows us that there is an extremely statistically significant difference in the averages rates between the time periods in the data.**
...
**There are significant differences between the spike year and pre-spike period and the post-spike period and the pre-spike period, but not between the spike year and the post-spike period, as those results have overlapping margins of error, while the pre-spike margin doesn't overlap with either.**

**Hed: A year after thefts spiked, the crime's rate remain high**

**Lede: A year after a wave of thefts rocked Hypothetical City, the crime epidemic has subsided, but only slightly. Theft rates remain far above pre-2023 levels, when it hovered around 20 thefts per capita. This year, rates doubled that, hovering around 40 thefts per capita.**