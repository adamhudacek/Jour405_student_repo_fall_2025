...
**Higher education groups, specifically college graduates, are likely to be overrepresented in the general population due to their higher civic engagement and greater access to pollsters. College-educated individuals are more likely to live in urban or affluent-suburban communities, the opinions of which have been historically overrepresented within survey data, since access to those areas is greater.**
...
**College graduates are likely to vote at a higher rate than those with high school diplomas**
...
**The 'High School or less' category showed the only significant change, with the group voting less in the weighted date than the unweighted data. Voting patterns stayed about the same for 'College' and 'Some college'.**

2. Why might the weighted results be considered more accurate than the unweighted results?

**The weighted results take into account the possible impacts of surveying biases within the data, while the unweighted assumes no biases exist within the data.**
...
**If reporters blindly report raw data without considering weight, they risk misrepresenting certain groups or individuals that were impacted by surveying biases during data collection or surveying.**
2. How might the differences between weighted and unweighted results affect how you would report on this data?

**It can show a reporter which populations are being overlooked by the data, or may be underrepresented in other polls on the issue/election. That in turn could impact the final results of public opinion or an election, like it did in 2016 when certain voters were vastly underestimated in their support for Donald Trump.**
...
**I would want to know if there was a possibility of bias within the weight calculations, because incorrectly weighted data can create new problems and inaccuracies that could trip up data reporters.**
