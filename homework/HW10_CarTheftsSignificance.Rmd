...
**WRITE ANSWERS HERE:** There appears to be a trend within the data, however, without a larger time scale, it's impossible to say whether crime is decreasing overall, or just in the summer months, since crime levels were similar in the winters of 2024 and 2025, but summer 2023 was much higher than summer 2023. 
...
- What does the 95% confidence interval show here? **WRITE ANSWER HERE:** It shows that based on this data, if we sample another collection of months, we're confident that the mean will appear within the highlighted section 95% of the time. 

- What figure(s) accurately reflects the number of car thefts in a typical month? **WRITE ANSWER HERE:** The mean: about 460 car thefts. 

- Propose a headline about the trend in car thefts that is focused on the present and future, but informed by the data you see above. **WRITE ANSWER HERE:** Car thefts down significantly Hypothetical City since 2023. 
...
Given the above chart, is the difference between the two periods statistically significant? Can we reject the null hypothesis? **WRITE ANSWER HERE:** The difference between the two is not statistically significant, due to overlapping margins of error. Because of this, we cannot reject the null hypothesis. 

How would you revise your headline from Task 6, if at all? What would you tell your editor, and what would you expect her to ask you? **WRITE ANSWER HERE:** I would revise it to specify that car thefts are down year-over-year, and explain to my editor that although summer months have higher crime, the latter year had less crime in both summer and winter when compared to the year prior, even when taking into account the difference in season. 
